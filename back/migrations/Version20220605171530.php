 ...
 */
final class Version20220605171530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces ADD categorie_id INT NOT NULL, ADD images VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces DROP categorie_id, DROP images');
    }
}
